            ...
            <div class="field">
                ...
                <div class="control">
                    <input class="input {{ $errors->has('name') ? 'is-danger' : '' }}" type="text" name="name"
                        placeholder="Restaurant name ..." value="{{ old('name') ?? $restaurant->name }}">
                    @error('name')
            ...
            <div class="field">
                ...
                <div class="control">
                    <input class="input {{ $errors->has('logo') ? 'is-danger' : '' }}" type="text" name="logo"
                        ...
                        value="{{ old('logo') ?? $restaurant->logo }}">
                    @error('logo')
                        <p class="help is-danger">{{ $message }}</p>
                    @enderror
                </div>
            ...
            <div class="field">
                ...
                <div class="control">
                    <textarea class="textarea {{ $errors->has('working_hours') ? 'is-danger' : '' }}" name="working_hours"
                        placeholder="Restaurant working_hours write here ..."
                        value="{{ old('working_hours') ?? $restaurant->working_hours }}">Working_hours</textarea>
                    @error('working_hours')
                        <p class="help is-danger">{{ $message }}</p>
                    @enderror
                </div>
            ...
            <div class="field">
                ...
                <div class="control">
                    <textarea class="textarea {{ $errors->has('rating') ? 'is-danger' : '' }}" name="rating"
                        placeholder="Restaurant rating write here ..."
                        value="{{ old('rating') ?? $restaurant->rating }}">Rating</textarea>
                    @error('rating')
                        <p class="help is-danger">{{ $message }}</p>
                    @enderror
                </div>
