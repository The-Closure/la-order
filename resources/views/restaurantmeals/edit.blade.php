    ...
    <div class="container">
        <form action="{{ route('meals.update', $meal->id) }}" method="post">
            ...
            <div class="field">
                ...
                <div class="control">
                    <input class="input {{ $errors->has('name meal') ? 'is-danger' : '' }} " type="text" name='name meal'
            ...
            <div class="field">
                ...
                <div class="control">
                    <textarea class="textarea {{ $errors->has('description') ? 'is-danger' : '' }} " name='descrription'
            ...
            <div class="field">
                ...
                <div class="control">
                    <input class="input {{ $errors->has('price meal') ? 'is-danger' : '' }} " type="text" name='price meal'
