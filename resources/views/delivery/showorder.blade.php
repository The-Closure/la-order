          ...
          <tr>
            ...
            <td>
              @if ($order->status == 'pending')
                <a class="button is-primary" href="{{ route('markAsAccepted', $order->id) }}">Mark As Accepted</a>
              @endif
              @if ($order->status == 'Done')
                it's done
              @endif
              @if ($order->status == 'Deliver')
                <a class="button is-primary" href="{{ route('markAsDone', $order->id) }}">Mark As done</a>
              @endif
            </td>
          </tr>
          @endforeach
